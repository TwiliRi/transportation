    ...
    <header className="">
      ...
      <div className="flex flex-row gap-6 items-center justify-center  w-full ">
          ...
          <div className={`flex flex-col items-center  justify-around w-[60%] max-sm:w-[100%] z-20 rounded-md p-3 ${isVisible ? 'animate-fadeInRight delay-200' : 'opacity-0'}`}>
            ...
            <Link href="https://www.avito.ru/ryazan/predlozheniya_uslug/gruzoperevozki_4385585661"><button className="cursor-pointer border-black border-2 w-full rounded-md p-2 text-black transition-all duration-300 hover:bg-black hover:text-white hover:scale-105 hover:shadow-lg">Написать в Авито</button></Link>
